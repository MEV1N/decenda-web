                ...
                {activeChallenge && (
                    ...
                    >
                        <motion.div
                            ...
                            className="bg-zinc-900 border border-zinc-800 p-8 rounded shadow-2xl max-w-lg w-full relative max-h-[90vh] flex flex-col"
                        >
                            <button
                                onClick={() => { setActiveChallenge(null); setFlagInput(''); setSubmitMsg(''); }}
